...
public class DevOpsFrameworkNexusPullStep extends Step {
    ...
    public StepExecution start(StepContext context) throws Exception {
        return new DevOpsFrameworkNexusPullStepExecution(this, context);
    }
    ...
    public static class DescriptorImpl extends StepDescriptor {
        ...
        public String getFunctionName() {
            return "devOpsFrameworkNexusPullStep";
        }

        @Nonnull
        @Override
        public String getDisplayName() {
            return "Pull file from Nexus-based repo";
        }
