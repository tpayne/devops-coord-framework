...
public class DevOpsFrameworkArtifactoryPushStep extends Step {
    ...
    public StepExecution start(StepContext context) throws Exception {
        return new DevOpsFrameworkArtifactoryPushStepExecution(this, context);
    }
    ...
    public static class DescriptorImpl extends StepDescriptor {
        ...
        public String getFunctionName() {
            return "devOpsFrameworkArtifactoryPushStep";
        }

        @Nonnull
        @Override
        public String getDisplayName() {
            return "Push file to Artifactory-based repo";
        }
