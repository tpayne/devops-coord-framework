...
public class DevOpsFrameworkScmSvnCloneStep extends Step {
    ...
    public StepExecution start(StepContext context) throws Exception {
        return new DevOpsFrameworkScmSvnCloneStepExecution(this, context);
    }
    ...
    public static class DescriptorImpl extends StepDescriptor {
        ...
        public String getFunctionName() {
            return "devOpsFrameworkSvnCloneStep";
        }

        @Nonnull
        @Override
        public String getDisplayName() {
            return "Svn Cloning step";
        }
