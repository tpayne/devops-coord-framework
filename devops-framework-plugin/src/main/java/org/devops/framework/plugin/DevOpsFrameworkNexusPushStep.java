...
public class DevOpsFrameworkNexusPushStep extends Step {
    ...
    public DevOpsFrameworkNexusPushStep(String srcFile, String targetFile,
    ...
    public StepExecution start(StepContext context) throws Exception {
        return new DevOpsFrameworkNexusPushStepExecution(this, context);
    }
    ...
    public static class DescriptorImpl extends StepDescriptor {
        ...
        public String getFunctionName() {
            return "devOpsFrameworkNexusPushStep";
        }

        @Nonnull
        @Override
        public String getDisplayName() {
            return "Push file to Nexus-based repo";
        }
