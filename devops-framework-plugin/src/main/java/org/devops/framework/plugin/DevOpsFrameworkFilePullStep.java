...
public class DevOpsFrameworkFilePullStep extends Step {
    ...
    public StepExecution start(StepContext context) throws Exception {
        return new DevOpsFrameworkFilePullStepExecution(this, context);
    }
    ...
    public static class DescriptorImpl extends StepDescriptor {
        ...
        public String getFunctionName() {
            return "devOpsFrameworkFilePullStep";
        }

        @Nonnull
        @Override
        public String getDisplayName() {
            return "Pull file from file-based repo";
        }
