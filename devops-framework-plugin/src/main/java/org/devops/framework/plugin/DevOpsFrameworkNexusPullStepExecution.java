...
public class DevOpsFrameworkNexusPullStepExecution extends SynchronousNonBlockingStepExecution<Boolean> {
    ...
    private transient final DevOpsFrameworkNexusPullStep step;

    /**
     * Default constructor
     * 
     * @param DevOpsFrameworkNexusPullStep - step
     * @param StepContext - context
     */
    DevOpsFrameworkNexusPullStepExecution(DevOpsFrameworkNexusPullStep step, StepContext context) {
        super(context);
        this.step = step;
    }
    ...
    protected Boolean run() throws Exception {
        ...
        boolean retStat = Repository.pullAssetFromRepo(ConfigPropertiesConstants.NEXUS,
                                step.getSrcFile(),
                                step.getTargetFile(),
